...
LOCAL = Local({
    ...
    'WELCOME_MESSAGE' : "Hi!\nI'm <b>Torrent Leech Bot </b>!\nPowered by pyrogram.\nMade By: <a href='http://t.me/KevinDaGoat</a>",
    ...
    'COMMAND_PASSWORD' : 'enter password that @KevinDaGoat gave you',
